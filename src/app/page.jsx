...
export default function Home() {
  return (
    ...
    <section className="flex font-poppins bg-blue-400  justify-center items-center h-screen">
      <div>
        ...
        <div className="space-x-4   mt-10 font-semibold">
          ...
          <Link className="hover:border-b-2 transition-all duration-75" href={"/profile"}>Profile</Link>
          <Link className="hover:border-b-2 transition-all duration-75" href={"/checkout"}>Profile</Link>
        </div>
      </div>
    </section>
    </>
